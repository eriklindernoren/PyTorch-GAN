...
criterion_feature_match = torch.nn.L1Loss()

# Loss weight of L1 feature-wise loss between translated image and real image
lambda_feature_match = 100
...
for epoch in range(opt.epoch, opt.n_epochs):
    for i, imgs in enumerate(dataloader):
        ...
        real_features = Variable(vgg19(imgs_hr).data, requires_grad=False)
        loss_feature_match = criterion_feature_match(gen_features, real_features)

        # Total loss
        loss_G = loss_GAN + lambda_feature_match * loss_feature_match
